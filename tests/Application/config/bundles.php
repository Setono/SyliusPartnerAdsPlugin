...
return [
    ...
    // Must be registered before SyliusGridBundle so the resource (and the
    // setono_sylius_partner_ads.model.program.class parameter) is available when the grid is built.
